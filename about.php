                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="images/slider-img.jpg" class="featured-image img-fluid">
                        </div>

                        <div class="col-lg-6 col-12">
                            <div class="featured-block">
                                <h2 class="mb-4">Vita Library Since 2018</h2>
                                ...
                                <p> Work is a blue color theme HTML CSS template for your company website. You may use this template for any purpose.</p>
